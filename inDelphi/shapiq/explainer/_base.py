...
class Explainer:
    ...
    def __init__(self, model, data: np.ndarray = None, **kwargs) -> None:
        ...
        if data is not None:
            ...
            try:
                ...
                print("Error: The `data` provided is not compatible with the model. {}".format(e))
                pass
        self.data = data
    ...
    def explain_X(
        self, X: np.ndarray, n_jobs: Optional[int] = None, random_state: Optional[int] = None, **kwargs
